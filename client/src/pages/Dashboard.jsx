          ...
          >
            ...
            >
              ...
              <button
               ...
               text-white rounded hover:bg-green-700 transition-colors duration-1000"
              >
                Create Resume
              </button>
          ...
          >
            ...
            >
              ...
              <button
                disabled={isLoading}
                className="w-full py-2 bg-green-600
               text-white rounded hover:bg-green-700 transition-colors flex items-center gap-2 justify-center "
              >
                {isLoading && (
